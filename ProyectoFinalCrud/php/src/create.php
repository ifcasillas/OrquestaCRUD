...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        $sql = "INSERT INTO teacher (name, position, salary) VALUES (?, ?, ?)";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Agregar Teacher</h2>
                    </div>
                    <p>Favor diligenciar el siguiente formulario, para agregar el teacher.</p>
